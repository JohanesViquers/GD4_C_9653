<?php // ini buat ngecek tombol yang namenya 'register' sudah di pencet atau belum

// $_POST itu method di formnya
if(isset($_POST['login'])) {
    include('../db.php'); // untuk mengoneksikan dengan databas dengan memanggil file
    db.php //tampung nilai yang ada di from ke variable
    ...
    emailnya tdk ditemukan if(mysqli_num_rows($query)==0) {
        echo '<script>
alert("Email not found!");
        ...
        if(password_verify($password, $user['password'])) {
            ...
            login ato belum $_SESSION['isLogin']=true;
            $_SESSION['user']=$user;
            echo '<script>
alert("Login Success");
